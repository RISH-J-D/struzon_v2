...
function createTextTexture(gl: any, text: string, font = 'bold 30px Figtree', color = 'black') {
...
class Title {
  ...
  constructor({ gl, plane, renderer, text, textColor = '#545050', font = '30px Figtree' }: any) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class App {
  ...
  constructor(
    ...
    // Explicitly bind methods used as event listeners or RAF callbacks
    this.onResize = this._onResize.bind(this);
    this.onWheel = this._onWheel.bind(this);
    this.onTouchDown = this._onTouchDown.bind(this);
    this.onTouchMove = this._onTouchMove.bind(this);
    this.onTouchUp = this._onTouchUp.bind(this);
